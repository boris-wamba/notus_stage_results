...
for i in range(1, 5):
    ...
    plt.legend()
    #plt.savefig( f"figures/coupe_1d_delta_{i}dx_trapz_1dx.png" )
    ...
    plt.legend()
    #plt.savefig(f"figures/coupe_1d_delta_{i}dx_trapz_2dx.png")
    ...
    plt.legend()
    #plt.savefig(f"figures/coupe_1d_delta_{i}dx_trapz_3dx.png")
    ...
    plt.legend()
    #plt.savefig(f"figures/coupe_1d_delta_{i}dx_trapz_4dx.png")
