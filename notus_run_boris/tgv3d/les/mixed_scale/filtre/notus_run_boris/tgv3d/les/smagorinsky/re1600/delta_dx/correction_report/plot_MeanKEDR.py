...
plt.plot(time_32, MeanKEDR_32,color='C3',  label='SMG $ 32^3$')
plt.plot(time_64, MeanKEDR_64, label='SMG $ 64^3$')
plt.plot(time_128, MeanKEDR_128, label='SMG $ 128^3$')
plt.plot(time_256, MeanKEDR_256, label='SMG $ 256^3$')
...
# Ajout d'une légende
plt.legend(loc='upper left', bbox_to_anchor=(0.02, 1.0),fontsize=11.5,borderpad=1.5, handletextpad=1.5, markerscale=2, edgecolor='black', framealpha=1)


# Sauvegarde de la figure
plt.savefig('les_mean_kedr_SMG')
