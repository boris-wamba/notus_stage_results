...
#plt.ylabel(r'$< 2\nu\bar{S}_{ij}\bar{S}_{ij}>$',fontsize=15)
plt.ylabel(r'$< 2\nu\,\overline{S}_{ij}\,\overline{S}_{ij} >$', fontsize=15)
plt.legend(fontsize=11,frameon=True, borderpad=1.5, handletextpad=1.5,
           markerscale=2, edgecolor='black', framealpha=1)

# Ajout d'une flèche oblique au centre de la figure
plt.annotate(
    '',
    xy=(0.65, 0.95),      # pointe de la flèche
    xytext= (0.45, 0.10),  # début de la flèche
