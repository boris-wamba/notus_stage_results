...
plt.title(r'LES SMG,  $\overline{\Delta} =  \Delta x $')
plt.plot(time_32, MeanKEDR_32, color='C3', label=r'SMG $32^3$')
plt.plot(time_64, MeanKEDR_64, label=r'SMG $64^3$')
...
#plt.plot(time_brachet, MeanKEDR_brachet, linestyle='--', color='purple', label=r'Brachet', lw=1.5 )
