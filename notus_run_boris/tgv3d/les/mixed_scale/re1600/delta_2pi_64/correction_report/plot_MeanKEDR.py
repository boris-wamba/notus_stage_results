...
plt.plot(time_128, MeanKEDR_128,color='C1', label=r'$\Delta x_0 = \frac{\Delta x_0}{2}$,     $128^3$')
plt.plot(time_256, MeanKEDR_256,color='C2', label=r'$\Delta x_0 = \frac{\Delta x_0}{4}$,     $256^3$')
...
# Ajout d'une légende
plt.legend(loc='upper left', bbox_to_anchor=(0.02, 1.0),fontsize=10.0,borderpad=1.0, handletextpad=1.5, markerscale=2, edgecolor='black', framealpha=1)
